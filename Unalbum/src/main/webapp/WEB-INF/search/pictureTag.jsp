    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <nav class="pagination">
                ...
                <c:if test="${pageUtil.index != 1}">
                    <a class="page-numbers prev" href="/search/pictureTag?currIndex=${pageUtil.index-1}&keyword=${keyword}">
                        Prev
                    </a>
                </c:if>
                <c:forEach begin="1" end="${pageUtil.pageNumber}" var="i">
                    ...
                    <c:if test="${pageUtil.index != i}">
                        <a href="/search/pictureTag?currIndex=${i}&keyword=${keyword}" class="page-numbers">${i}</a>
                    </c:if>
                </c:forEach>
                ...
                <c:if test="${pageUtil.index != pageUtil.pageNumber}">
                    <a class="page-numbers next" href="/search/pictureTag?currIndex=${pageUtil.index+1}&keyword=${keyword}">
                        Next
                    </a>
                </c:if>
            </nav>
