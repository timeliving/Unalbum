...
<div class="x-body">
    ...
    <div class="page">
        <div>
            ...
            <c:if test="${pageUtil.index != 1}">
                <a class="prev" href="/user/picturesByUserAndDate?currIndex=${pageUtil.index-1}&beginDate=${beginDate}&endDate=${endDate}">
                    &lt;&lt;
                </a>
            </c:if>
            <c:forEach begin="1" end="${pageUtil.pageNumber}" var="i">
                ...
                <c:if test="${pageUtil.index != i}">
                    <a href="/user/picturesByUserAndDate?currIndex=${i}&beginDate=${beginDate}&endDate=${endDate}" class="num">${i}</a>
                </c:if>
            </c:forEach>
            ...
            <c:if test="${pageUtil.index != pageUtil.pageNumber}">
                <a class="next" href="/user/picturesByUserAndDate?currIndex=${pageUtil.index+1}&beginDate=${beginDate}&endDate=${endDate}">
                    &gt;&gt;
                </a>
            </c:if>
        </div>
