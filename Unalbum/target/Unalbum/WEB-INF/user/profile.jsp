        ...
        <div class="sheet sheet--padding">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-9">
                    <h1 class="heading--margin-small delta text-sans text-weight--bold">修改头像</h1>



                    <div class="form">
                        <form class="edit_user" id="edit_user_766708" action="<c:url value="/user/account/profile" />" accept-charset="UTF-8" method="post" enctype="multipart/form-data">
